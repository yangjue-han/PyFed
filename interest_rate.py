...
class vendor:
    ...
    def fed_repo(self, output = 'both'):
        ...
        fedrrp_url='https://websvcgatewayx2.frbny.org/autorates_tomo_external/services/v1_0/tomo/retrieveHistoricalExcel?f=07072000&t=03302020&ctt=true&&cta=true&ctm=true'
